...
\begin{enumerate}
    ...
    \item \(\mathcal T \cap G_0^+ = \{e\}\) (Klassifikation nach Fixpunkten, \cref{sec:wiederholung}) %\anm{Konjugiertheit von \(G_0^+\) zu allen anderen \(G_p^+\). Was soll diese Eigenschaft aussagen? Wo wird sie relevant?}
